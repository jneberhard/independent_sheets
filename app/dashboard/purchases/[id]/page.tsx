...
export default async function PurchasesPage({ params }: PageProps) {
  ...
  return (
    // Changed layout from a centered flex-box to a natural vertical layout shell
    <main className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">

        {/* Structured Dashboard Context Header Block */}
        <div className="mb-8 pb-5 border-b border-black">
